      ...
      <v-row class="mobile-column-reverse">
        ...
        <v-col cols="12" md="5">
          ...
          <div class="py-3" style="border-top: 1px solid grey">
            <div class="total-price d-flex justify-space-between pb-3">
              <span>subtotal:</span>
              <span style="font-weight: 600">${{ totalPrice.toFixed(2) }}</span>
            </div>
            <div class="total-price d-flex justify-space-between pb-3">
              <span>Shipping:</span>
              <span style="font-weight: 600">${{ shiping }}</span>
            </div>
            <div
              class="total-price d-flex justify-space-between pb-3"
...
export default {
  ...
  data() {
    return {
      counter: 0,
      items: ["Egypt", "Saudi Arabia", "Qatar", "Bahrain", "Oman", "Yemen"],
      shiping: parseInt(localStorage.getItem("shippingPrice")),
    };
  },
  computed: {
